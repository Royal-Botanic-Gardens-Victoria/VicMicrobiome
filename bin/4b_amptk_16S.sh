...
amptk illumina -i ../data/16S/trimmed -o 16S -f AGAGTTTGATCMTGGCTCAG -r GWATTACCGCGGCKGCTG -l 500 -p off --min_len 150 --reads paired --rescue_forward off --require_primer off --cleanup

# Move output files to new folder in /data
mkdir ../data/16S/amptk
mv 16S.* ../data/16S/amptk
...
amptk cluster -i ../data/16S/amptk/16S.demux.fq.gz -o cluster16S --uchime_ref 16S
