...
amptk taxonomy -i ../data/ITS/amptk/filterITS.final.txt -f ../data/ITS/amptk/filterITS.filtered.otus.fa -o taxonomyITS -m ../data/ITS/amptk/mapping_file_ITS.txt -d ITS1 --tax_filter Fungi
